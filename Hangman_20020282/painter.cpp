...
Painter::Painter(SDL_Window* window, SDL_Renderer* renderer_ = nullptr, TTF_Font* font_ = nullptr ): renderer(renderer_), font(font_){
...
void Painter::creatSquare(float size)
{
    for(int i= 0; i<2; ++i)
    {
        moveForward(size);
